...
public class SchedulesApi {
    ...
    public okhttp3.Call createScheduleCall(CreateScheduleRequest createScheduleRequest, final ApiCallback _callback) throws ApiException {
        ...
        localVarHeaderParams.put("X-LUSID-SDK-Version", "0.0.759");
    ...
    private okhttp3.Call createScheduleValidateBeforeCall(CreateScheduleRequest createScheduleRequest, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = createScheduleCall(createScheduleRequest, _callback);
        return localVarCall;
     ...
     */
    public ScheduleDefinition createSchedule(CreateScheduleRequest createScheduleRequest) throws ApiException {
     ...
     */
    public ApiResponse<ScheduleDefinition> createScheduleWithHttpInfo(CreateScheduleRequest createScheduleRequest) throws ApiException {
    ...
    /**
     * [EXPERIMENTAL] CreateSchedule: Create a Schedule for a job (asynchronously)
     * 
     * @param createScheduleRequest  (required)
     ...
     */
    public okhttp3.Call createScheduleAsync(CreateScheduleRequest createScheduleRequest, final ApiCallback<ScheduleDefinition> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call deleteScheduleCall(String scope, String code, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call deleteScheduleValidateBeforeCall(String scope, String code, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = deleteScheduleCall(scope, code, _callback);
        return localVarCall;
     ...
     */
    public void deleteSchedule(String scope, String code) throws ApiException {
     ...
     */
    public ApiResponse<Void> deleteScheduleWithHttpInfo(String scope, String code) throws ApiException {
        okhttp3.Call localVarCall = deleteScheduleValidateBeforeCall(scope, code, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * [EXPERIMENTAL] DeleteSchedule: Delete a schedule (asynchronously)
     * 
     * @param scope Scope of the schedule to be deleted (required)
     * @param code Code of the schedule to be deleted (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call deleteScheduleAsync(String scope, String code, final ApiCallback<Void> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call enabledScheduleCall(String scope, String code, Boolean enable, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    private okhttp3.Call enabledScheduleValidateBeforeCall(String scope, String code, Boolean enable, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = enabledScheduleCall(scope, code, enable, _callback);
        return localVarCall;
     ...
     */
    public ScheduleDefinition enabledSchedule(String scope, String code, Boolean enable) throws ApiException {
     ...
     */
    public ApiResponse<ScheduleDefinition> enabledScheduleWithHttpInfo(String scope, String code, Boolean enable) throws ApiException {
    ...
    /**
     * [EXPERIMENTAL] EnabledSchedule: Enable/disable a schedule (asynchronously)
     * 
     * @param scope Scope of the schedule to be enabled/disabled (required)
     * @param code Code of the schedule to be enabled/disabled (required)
     * @param enable Specify whether to enable or disable the schedule (required)
     ...
     */
    public okhttp3.Call enabledScheduleAsync(String scope, String code, Boolean enable, final ApiCallback<ScheduleDefinition> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call getScheduleCall(String scope, String code, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    private okhttp3.Call getScheduleValidateBeforeCall(String scope, String code, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getScheduleCall(scope, code, _callback);
        return localVarCall;
     ...
     */
    public ScheduleDefinition getSchedule(String scope, String code) throws ApiException {
     ...
     */
    public ApiResponse<ScheduleDefinition> getScheduleWithHttpInfo(String scope, String code) throws ApiException {
    ...
    /**
     * [EXPERIMENTAL] GetSchedule: Get a single Schedule (asynchronously)
     * 
     * @param scope The scope of Schedule (required)
     * @param code The code of the Schedule (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call getScheduleAsync(String scope, String code, final ApiCallback<ScheduleDefinition> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call listSchedulesCall(String page, List<String> sortBy, Integer start, Integer limit, String filter, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    private okhttp3.Call listSchedulesValidateBeforeCall(String page, List<String> sortBy, Integer start, Integer limit, String filter, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = listSchedulesCall(page, sortBy, start, limit, filter, _callback);
        return localVarCall;
     ...
     */
    public ResourceListOfScheduleDefinition listSchedules(String page, List<String> sortBy, Integer start, Integer limit, String filter) throws ApiException {
     ...
     */
    public ApiResponse<ResourceListOfScheduleDefinition> listSchedulesWithHttpInfo(String page, List<String> sortBy, Integer start, Integer limit, String filter) throws ApiException {
    ...
    /**
     * [EXPERIMENTAL] ListSchedules: List the available Schedules (asynchronously)
     * 
     * @param page The pagination token to use to continue listing instruments from a previous call to list instruments.              This value is returned from the previous call. If a pagination token is provided the sortBy and filter fields              must not have changed since the original request. Also, if set, a start value cannot be provided. (optional)
     * @param sortBy Order the results by these fields. Use use the &#39;-&#39; sign to denote descending order e.g. -MyFieldName. (optional)
     * @param start When paginating, skip this number of results. (optional)
     ...
     */
    public okhttp3.Call listSchedulesAsync(String page, List<String> sortBy, Integer start, Integer limit, String filter, final ApiCallback<ResourceListOfScheduleDefinition> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call runScheduleCall(String scope, String code, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    private okhttp3.Call runScheduleValidateBeforeCall(String scope, String code, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = runScheduleCall(scope, code, _callback);
        return localVarCall;
     ...
     */
    public StartScheduleResponse runSchedule(String scope, String code) throws ApiException {
     ...
     */
    public ApiResponse<StartScheduleResponse> runScheduleWithHttpInfo(String scope, String code) throws ApiException {
    ...
    /**
     * [EXPERIMENTAL] RunSchedule: Run a schedule immediately (asynchronously)
     * 
     * @param scope The schedule scope (required)
     * @param code The schedule cde (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call runScheduleAsync(String scope, String code, final ApiCallback<StartScheduleResponse> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call updateScheduleCall(String scope, String code, UpdateScheduleRequest updateScheduleRequest, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call updateScheduleValidateBeforeCall(String scope, String code, UpdateScheduleRequest updateScheduleRequest, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = updateScheduleCall(scope, code, updateScheduleRequest, _callback);
        return localVarCall;
     ...
     */
    public ScheduleDefinition updateSchedule(String scope, String code, UpdateScheduleRequest updateScheduleRequest) throws ApiException {
     ...
     */
    public ApiResponse<ScheduleDefinition> updateScheduleWithHttpInfo(String scope, String code, UpdateScheduleRequest updateScheduleRequest) throws ApiException {
    ...
    /**
     * [EXPERIMENTAL] UpdateSchedule: Update a schedule. (asynchronously)
     * 
     * @param scope Scope of the schedule to be updated (required)
     * @param code Code of the schedule to be updated (required)
     * @param updateScheduleRequest The updated schedule (required)
     ...
     */
    public okhttp3.Call updateScheduleAsync(String scope, String code, UpdateScheduleRequest updateScheduleRequest, final ApiCallback<ScheduleDefinition> _callback) throws ApiException {
