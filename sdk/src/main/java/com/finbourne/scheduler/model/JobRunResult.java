...
public class JobRunResult {
  ...
  **/
  ...
  public JobRunResult startDate(OffsetDateTime startDate) {
   ...
   /**
   * Start date of the job  Defaults to null if the job has not started yet ( is in a pending status )
   * @return startDate
  **/
  @ApiModelProperty(value = "Start date of the job  Defaults to null if the job has not started yet ( is in a pending status )")
